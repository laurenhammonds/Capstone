package com.teksystems.capstone1.config;
	...
	protected void configure(final HttpSecurity http) throws Exception {
		http
	        ...
	        .authorizeRequests()
	        	...
	        	// this has the effect of making all requests require authentication which is a design pattern
	        	// once all is security then we provided exceptions using permitAll
